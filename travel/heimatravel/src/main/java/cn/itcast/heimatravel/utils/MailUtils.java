...
public final class MailUtils {
    private static final String USER = "574853556@qq.com"; // 发件人称号，同邮箱地址
    private static final String PASSWORD = "stzivjkvgplybbee"; // 如果是qq邮箱可以使户端授权码，或者登录密码
    ...
    public static void main(String[] args) throws Exception { // 做测试用
       /* MailUtils.sendMail("cocoMINATO@163.com","<img src='http://localhost:8088/travel/images/collection_pic.jpg' >你好，这是一封测试邮件，无需回复。","测试邮件");
        System.out.println("发送成功");*/
  /*  RouteService routeService=new RouteServiceImpl();
        PageBean<Route> rankpb = routeService.rankpb("", "1", 6, "", "");
        List<Route> list = rankpb.getList();
